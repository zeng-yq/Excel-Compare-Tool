...
export function FooterI18n({ locale, dictionary }: FooterI18nProps) {
  ...
  // Use provided dictionary footer, fallback to English if no dictionary provided
  const footer = dictionary?.footer || {
    description: "Excel Compare: Free, secure spreadsheet comparison with synchronized scrolling and instant diff highlighting. Processed locally, no installation required.",
    quickLinks: "Quick Links",
    connect: "Contact",
    home: "Home",
    articles: "Articles",
    github: "support@excelcompare.org",
    privacyPolicy: "Privacy Policy",
    termsOfService: "Terms of Service",
    copyright: `© ${new Date().getFullYear()} Excel Compare. All rights reserved.`
  };
    ...
    <footer className="bg-gray-100 border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="text-sm font-semibold text-gray-600 tracking-wider uppercase">{footer.quickLinks}</div>
          ...
          <div>
            <div className="text-sm font-semibold text-gray-600 tracking-wider uppercase">{footer.connect}</div>
            <ul className="mt-4 space-y-4">
              <li>
